...
- **Massive Catalog**: Includes **ALL Building Blocks** (Stones, Deepslate, Wood, Glass, Nature, etc.), full **Pale Garden & Copper updates**, and over **60+ Mob Spawners**. 
...
- **Historical Trading**: Items not natively part of the server market (like Enchanted Books/Ingots) intelligently query the database to display their most recent **Last Sold Price** from player trading history.
- **Trends**:
...
- **"Unknown Command"**: If `/market` or `/eco` says "Unknown command", the plugin failed to load.
    ...
    - Ensure you are running **Paper 1.21.11**.
- **"No Permission"**:
