#!/usr/bin/env python3
"""Remove custom-item-detection-test from 1.21.x workflow."""
...
# Find and remove the custom-item-detection-test job
start = content.find("  custom-item-detection-test:")
if start == -1:
    print("Job not found - already clean")
else:
    end = len(content)
    ...
    print(f"Removed {len(removed)} chars of detection test job")
