#!/usr/bin/env python3
"""Add back missing customItemRegistry.saveToDatabase to 26.x onDisable and periodic timer."""
...
result = push_file("src/main/java/com/aureleconomy/AurelEconomy.java", content,
                    "fix: add back missing customItemRegistry save calls in timer and onDisable (26.x)", BRANCH, token, sha)
print(f"Fixed 26.x AurelEconomy.java (sha: {result['content']['sha'][:8]})")
